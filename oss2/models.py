...
class NonCurrentVersionExpiration(object):
    ...
    :param non_current_days: 指定多少天之后删除
    :type non_current_days: int
    """
    def __init__(self, non_current_days):
...
class NonCurrentVersionStorageTransition(object):
    ...
    :param non_current_days: 多少天之后转存储
    :type non_current_days: int
    """
    def __init__(self, non_current_days, storage_class):
        self.non_current_days = non_current_days
        self.storage_class = storage_class
...
class LifecycleRule(object):
    ...
    :param non_current_version_expiration: 指定Object非当前版本生命周期规则的过期属性。适用于多版本场景。
    :type non_current_version_expiration class:`NonCurrentVersionExpiration <oss2.models.NonCurrentVersionExpiration>`

    :param non_current_version_sotrage_transitions: 在有效生命周期中，OSS何时将指定Object的非当前版本转储为IA或者Archive存储类型，适用于多版本场景。
    :type non_current_version_sotrage_transitions: list of class:`NonCurrentVersionStorageTransition <oss2.models.NonCurrentVersionStorageTransition>`
    """
    ...
    def __init__(self, id, prefix,
                 ...
                 non_current_version_sotrage_transitions=None):
        self.id = id
        self.prefix = prefix
        self.status = status
        ...
        self.non_current_version_expiration = non_current_version_expiration
        self.non_current_version_sotrage_transitions = non_current_version_sotrage_transitions
