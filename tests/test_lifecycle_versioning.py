...
class TestLifecycleVersioning(OssTestCase):
    ...
    def test_lifecycle_versioning(self):
        ...
        rule = LifecycleRule('rule1', 'test-prefix',
                      ...
                      non_current_version_expiration = NonCurrentVersionExpiration(30),
                      non_current_version_sotrage_transitions = 
        ...
        self.assertEquals(30, lifecycle.rules[0].non_current_version_expiration.non_current_days)
        self.assertEquals(2, len(lifecycle.rules[0].non_current_version_sotrage_transitions))
        bucket.delete_bucket()
