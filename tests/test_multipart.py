...
class TestMultipart(OssTestCase):
    ...
    def test_crypto_multipart_upload(self):
        for crypto_bucket in [self.rsa_crypto_bucket, self.kms_crypto_bucket]:
            ...
            for i in range(3):
                ...
                parts.append(
                    oss2.models.PartInfo(i + 1, upload_result.etag, size=part_size, part_crc=upload_result.crc))
            ...
            get_result_range_1 = crypto_bucket.get_object(key, byte_range=(0, 102399))
            ...
            get_result_range_2 = crypto_bucket.get_object(key, byte_range=(102400, 204799))
            ...
            get_result_range_3 = crypto_bucket.get_object(key, byte_range=(204800, 307199))
    ...
    def test_crypto_upload_invalid_part_content(self):
        for crypto_bucket in [self.rsa_crypto_bucket, self.kms_crypto_bucket]:
            ...
            # invalid part size
            self.assertRaises(oss2.exceptions.InvalidArgument, crypto_bucket.upload_part, key, upload_id, 1,
                              content_invalid,
    ...
    def test_crypto_upload_invalid_last_part_content(self):
        for crypto_bucket in [self.rsa_crypto_bucket, self.kms_crypto_bucket]:
            ...
            self.assertRaises(oss2.exceptions.InvalidArgument, crypto_bucket.upload_part, key, upload_id, 3,
                              content_invalid)
    ...
    def test_crypto_upload_invalid_part_number(self):
        for crypto_bucket in [self.rsa_crypto_bucket, self.kms_crypto_bucket]:
            ...
            self.assertRaises(oss2.exceptions.InvalidArgument, crypto_bucket.upload_part, key, upload_id,
    ...
    def test_crypto_complete_multipart_miss_parts(self):
        for crypto_bucket in [self.rsa_crypto_bucket, self.kms_crypto_bucket]:
            ...
            self.assertRaises(oss2.exceptions.InvalidEncryptionRequest, crypto_bucket.complete_multipart_upload, key,
                              upload_id, parts)
